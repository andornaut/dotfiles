...
alias spinshopify='spin up shopify --name shopify'
alias spinsshshopify='spin ssh shopify'
alias spinsshweb='spin ssh web'
alias spinweb='spin up shopify --name web'
...
alias tmuxserver='tmux new-session -As server -n main'
