...
alias allstop="pkill -f 'play -n -c1 synth whitenoise lowpass'"
alias bc="bc -l"
alias engage="nohup play -n -c1 synth whitenoise lowpass -1 120 lowpass -1 120 lowpass -1 120 gain +20 >/dev/null 2>&1 &"
...
alias gogapplyall='for r in $(gog repository list); do gog git -r ${r} pull && gog apply -r ${r}; done'
...
#alias npm='/home/andornaut/.local/lib/npm/bin/npm'
...
alias serve='echo -e "Serving ${PWD}\nat http://localhost:2015" && docker run --network host --volume ${PWD}:/var/www/html:ro joshix/caddy'
alias si="screen -d -R irssi irssi"
alias sr="screen -d -R rtorrent rtorrent"
alias vol="pavolume -v $@"

#if type Xephyr 1>/dev/null 2>/dev/null; then
#	alias xephyr="Xephyr :1 -ac -screen 800x600"
#fi
